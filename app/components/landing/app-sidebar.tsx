...
export function AppSidebar() {
    ...
    const chatProgress = usage && limits.chatMessages !== -1
        ? Math.min((usage.chatMessageToday / limits.chatMessages) * 100, 100)
        : 0
    ...
    return (
        <Sidebar collapsible="none" className="h-screen bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
                ...
                {usage && (
                    <div className="rounded-lg bg-sidebar-accent/50 p-3 mb-3">
                        <p className="text-xs font-medium text-sidebar-accent-foreground mb-3">
                            Current Plan: {usage.currentPlan}
                        </p>
                        ...
                        <div className="space-y-2 mb-3">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="text-xs text-sidebar-accent-foreground/70">
                                    {usage.chatMessageToday}/{limits.chatMessages === -1 ? '∞' : limits.chatMessages}
                                </span>
                            </div>
